...
public class CompassFragment extends AbstractTourFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         * clickBtn.setOnClickListener(this); Button distanceBtn =
         * (Button)rootView.findViewById(R.id.distance_button);
    ...
    public void onClick(View v) {
        ...
        // tracker.getLocation().bearingTo(tracker.createLocation(47.1491993,
        // 9.5174042));

        // SensorManager.getOrientation
        // float azimuth = // get azimuth from the orientation sensor (it's
        // quite simple)
        ...
        // true north
        // float bearing = currentLoc.bearingTo(target); // (it's already in
        // degrees)
        // float direction = azimuth - bearing;

        this.tracker = new GPSTracker(getActivity());

        //int distance = (int) tracker.getDistance(tracker.createLocation(47.1491993, 9.5174042));
        ...
        switch (v.getId()) {
        /*
         * case R.id.test_button: Toast.makeText(getActivity(), "current lat: "
         * + Double.toString(tracker.getLatitude()) + " current long: " +
         * Double.toString(tracker.getLongitude()), 150).show(); break; case
         * R.id.distance_button: // Toast.makeText(getActivity(), "bt: " + bt,
         * 150).show(); // Toast.makeText(getActivity(), "Current distance: " +
         * distance + "m", 150).show(); break;
         */
        }
    }
}
